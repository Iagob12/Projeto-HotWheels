package com.api.hotwheels.entities;
...
public class Carro {
    ...
    public Carro(Long id, String nome, String anoFabricacao, String serie, String numeroColecao, StatusDoTipo status, boolean favorito, String imagem) {
        this.id = id;
        this.nome = nome;
